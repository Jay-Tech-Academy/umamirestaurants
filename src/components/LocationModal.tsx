...
import { X, MapPin, Navigation, Clock, Phone, Car, Train, ExternalLink } from 'lucide-react';
...
export const LocationModal: React.FC<LocationModalProps> = ({
  ...
  return (
    ...
    >
      <div 
        className="relative w-full max-w-xl bg-[#121212] border border-[#D4AF37]/50 rounded-xl shadow-2xl overflow-hidden text-neutral-200"
